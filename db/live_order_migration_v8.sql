-- ============================================================================
-- v8 (버그수정): 그날 주문 취합을 "고객 이름" → "전화번호(정규화)" 기준으로
--   변경. 동명이인(전화 다름)이 배송비·결제수단·합계가 섞이던 문제 해결.
--   (create_live_order만 교체. 나머지 동일)
-- ============================================================================
...
begin
  ...
  -- ★ 그날 같은고객 취합: 이름(cust)이 아니라 전화번호(정규화) 기준 (동명이인 섞임 방지)
