...
const C: Record<Lang, any> = {
  ko: {
    ...
    cases: [
      { brand: "Dior × 지수 (BLACKPINK)", metric: "한국 매출 50% 증가", desc: "글로벌 앰배서더 발탁 후 Dior 한국 매출 약 6,100억 원 규모로 50% 증가. K-POP 팬덤의 조직적 소비력 입증." },
      { brand: "CELINE × V (BTS)", metric: "EMV 1,308만 달러", desc: "3일간 7벌의 셀린느 룩 착용, 미디어 노출 가치(EMV) 1,308만 달러 달성. 글로벌 앰배서더 효과 극대화." },
      { brand: "Gucci × 진 (BTS)", metric: "화보 의상 매진 사태", desc: "2024 글로벌 앰배서더 발탁 후 첫 화보 속 의상 전량 매진. 팬덤의 즉각적 구매 전환 입증." },
      { brand: "Prada × 카리나 (aespa)", metric: "K-POP 커뮤니티 화제", desc: "2024 브랜드 앰배서더 발탁, S/S 쇼 참석으로 K-POP 팬덤 내 브랜드 인지도 급상승." },
      { brand: "Louis Vuitton × 리사 (BLACKPINK)", metric: "아시아 시장 매출 견인", desc: "2024 글로벌 앰배서더 발탁. 동남아·한국·중국 팬덤을 통한 아시아 시장 매출 성장 주도." },
      { brand: "Burberry × 승민 (Stray Kids)", metric: "MZ세대 타깃 마케팅", desc: "2025 앰배서더 발탁. 4세대 아이돌 팬덤을 활용한 MZ세대 타깃 마케팅 전략의 대표 사례." },
    ],
  ...
  en: {
    ...
    cases: [
      { brand: "Dior × Jisoo (BLACKPINK)", metric: "Korea Sales +50%", desc: "After global ambassador appointment, Dior Korea revenue grew ~50% to approx. ₩610B. Proved the organized purchasing power of K-POP fandoms." },
      { brand: "CELINE × V (BTS)", metric: "$13.08M EMV", desc: "Wore 7 CELINE looks over 3 days, generating $13.08M in Earned Media Value. Maximized global ambassador impact." },
      { brand: "Gucci × Jin (BTS)", metric: "Lookbook Items Sold Out", desc: "First lookbook after 2024 global ambassador appointment sold out entirely. Proved fandom's immediate purchase conversion." },
      { brand: "Prada × Karina (aespa)", metric: "K-POP Community Buzz", desc: "2024 brand ambassador appointment and S/S show attendance drove massive brand awareness surge within K-POP fandoms." },
      { brand: "Louis Vuitton × Lisa (BLACKPINK)", metric: "Asia Market Growth Driver", desc: "2024 global ambassador. Led Asia market revenue growth through Southeast Asian, Korean, and Chinese fandoms." },
      { brand: "Burberry × Seungmin (Stray Kids)", metric: "Gen-Z Targeted Marketing", desc: "2025 ambassador appointment. A model case of Gen-Z targeted marketing leveraging 4th-gen idol fandoms." },
    ],
  ...
  zh: {
    ...
    cases: [
      { brand: "Dior × 智秀 (BLACKPINK)", metric: "韩国销售额增长50%", desc: "全球代言人任命后,Dior韩国销售额增长约50%,达到约6100亿韩元。验证了K-POP粉丝的组织性消费力。" },
      { brand: "CELINE × V (BTS)", metric: "EMV 1308万美元", desc: "3天内穿着7套CELINE造型,获得1308万美元的媒体曝光价值(EMV)。最大化全球代言人效果。" },
      { brand: "Gucci × 金硕珍 (BTS)", metric: "画报服装售罄", desc: "2024年全球代言人任命后首组画报中的服装全部售罄。验证粉丝的即时购买转化力。" },
      { brand: "Prada × Karina (aespa)", metric: "K-POP社区热议", desc: "2024年品牌代言人任命,出席S/S秀,K-POP粉丝群中品牌知名度急剧上升。" },
      { brand: "Louis Vuitton × Lisa (BLACKPINK)", metric: "亚洲市场增长引擎", desc: "2024年全球代言人。通过东南亚、韩国、中国粉丝群推动亚洲市场收入增长。" },
      { brand: "Burberry × 昇玟 (Stray Kids)", metric: "Z世代精准营销", desc: "2025年代言人任命。利用第四代偶像粉丝的Z世代精准营销战略的代表案例。" },
    ],
  ...
  ja: {
    ...
    cases: [
      { brand: "Dior × ジス (BLACKPINK)", metric: "韓国売上50%増加", desc: "グローバルアンバサダー就任後、Dior韓国の売上が約50%増の約6,100億ウォン規模に。K-POPファンダムの組織的消費力を実証。" },
      { brand: "CELINE × V (BTS)", metric: "EMV 1,308万ドル", desc: "3日間で7着のCELINEルックを着用、メディア露出価値(EMV)1,308万ドルを達成。グローバルアンバサダー効果を最大化。" },
      { brand: "Gucci × ジン (BTS)", metric: "画報衣装完売", desc: "2024年グローバルアンバサダー就任後の初画報衣装が全量完売。ファンダムの即時購買転換を実証。" },
      { brand: "Prada × カリナ (aespa)", metric: "K-POPコミュニティで話題", desc: "2024年ブランドアンバサダー就任、S/Sショー参加でK-POPファンダム内のブランド認知度が急上昇。" },
      { brand: "Louis Vuitton × リサ (BLACKPINK)", metric: "アジア市場売上牽引", desc: "2024年グローバルアンバサダー。東南アジア・韓国・中国のファンダムを通じたアジア市場売上成長を主導。" },
      { brand: "Burberry × スンミン (Stray Kids)", metric: "MZ世代ターゲットマーケティング", desc: "2025年アンバサダー就任。4世代アイドルファンダムを活用したMZ世代ターゲットマーケティングの代表事例。" },
    ],
