...
const C: Record<Lang, any> = {
  ko: {
    ...
    cases: [
      ...
      { brand: "펠리시티 (K-크리에이터 에이전시)", metric: "샤오홍슈 K-크리에이터 수출", desc: "한국어 콘텐츠를 중국어로 최적화하는 원스톱 시스템 구축. 샤오홍슈→더우인→틱톡샵 하이브리드 전략.", img: "/images/cases/ks6.jpg" },
    ],
  ...
  en: {
    ...
    cases: [
      ...
      { brand: "Felicity (K-Creator Agency)", metric: "Xiaohongshu K-Creator Export", desc: "Built a one-stop system converting Korean content to optimized Chinese. Hybrid strategy across Xiaohongshu → Douyin → TikTok Shop.", img: "/images/cases/ks6.jpg" },
    ],
  ...
  zh: {
    ...
    cases: [
      ...
      { brand: "Felicity (K-创作者代理)", metric: "小红书K创作者输出", desc: "构建韩语内容转化为优化中文的一站式系统。小红书→抖音→TikTok Shop混合策略。", img: "/images/cases/ks6.jpg" },
    ],
  ...
  ja: {
    ...
    cases: [
      ...
      { brand: "フェリシティ (K-クリエイターエージェンシー)", metric: "小紅書K-クリエイター輸出", desc: "韓国語コンテンツを最適化された中国語に変換するワンストップシステム構築。小紅書→抖音→TikTok Shopのハイブリッド戦略。", img: "/images/cases/ks6.jpg" },
    ],
